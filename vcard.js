(function(global) {
/**
 * minimal vCard generation library
 *
 * This implementation picks a mozContact object and converts it into a vCard string.
 * It doesn't convert all fields, only the most common ones.	
 */

global.contactToVcard = function(inContact) {
	var vCard = "",
		i = 0,
		len = 0,
		pref = false,
